#!/usr/bin/env python3
"""
alert_brainsight_v2.2.0.py
--------------------------
Real-time Brainsight drift monitor - version 2.2.0.
...
Adds (v2.1.0 -> v2.2.0):
  ...
  - Without the trigger flags, this is exactly v2.1.0: terminal-only alerts.
...
Carried over from v2.1.0:
  ...
  - Continuous discovery of Target Selection and Crosshairs Position rows
    from the live stream; first one auto-selected if none was active.

Usage
-----
    # Terminal-only (no trigger):
